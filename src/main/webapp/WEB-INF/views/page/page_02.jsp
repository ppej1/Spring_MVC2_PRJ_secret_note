    ...
    <section class="section element-animate">
      ...
      <div class="owl-carousel centernonloop">
        <a href="#" class="item-dishes">
          ...
          <img src="resources/template/img/dishes_1.jpg" alt="" class="img-fluid">
        </a>
        <a href="#" class="item-dishes">
          <div class="text">
        ...
        <a href="#" class="item-dishes">
          ...
          <img src="resources/template/img/dishes_3.jpg" alt="" class="img-fluid">
        </a>
        <a href="#" class="item-dishes">
          <div class="text">
            <p class="dishes-price">$12.00</p>
        ...
        <div class="row no-gutters">
          <div class="col-md-6">
            <div class="sched d-block d-lg-flex">
              <div class="bg-image order-2" style="background-image: url('resources/template/img/dishes_4.jpg');"></div>
          ...
          <div class="col-md-6">
            <div class="sched d-block d-lg-flex">
              <div class="bg-image order-2" style="background-image: url('resources/template/img/dishes_2.jpg');"></div>
              <div class="text order-1">
            ...
            <div class="sched d-block d-lg-flex">
              <div class="bg-image" style="background-image: url('resources/template/img/dishes_3.jpg');"></div>
              <div class="text">
    ...
    <section class="section element-animate">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="blog d-block d-lg-flex">
              <div class="bg-image" style="background-image: url('resources/template/img/dishes_2.jpg');"></div>
              <div class="text">
                <h3>How to cook beef steak with sauce</h3>
                <p class="sched-time">
                  <span><span class="fa fa-calendar"></span> April 22, 2018</span> <br>
