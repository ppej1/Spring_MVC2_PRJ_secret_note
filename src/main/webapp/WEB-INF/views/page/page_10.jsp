						...
						<div class="tm-bg-primary-dark tm-block tm-block-settings">
							...
							<div class="tm-signup-form row">
								<div class="form-group col-lg-6">
									...
									<select id="selectSub" size ="1" name="selectSub"class="form-control validate select_mcserialNumber">
									
									</select>
									<span id="mcserialNumber1"></span>
								</div>
								<div class="form-group col-lg-6">
									<label for="userid">담당자</label> 
									<input id="userid" name="userid" type="text" class="form-control validate" value="${sessionScope.loginId}" readonly="readonly"/>
									<span id="userid"></span>
								</div>
								<div class="form-group col-lg-6">
									<label for="rAmount">個数</label> 
									<input id="rAmount" name="rAmount" type="number" class="form-control validate" />
									<span id="rAmount"></span>
								</div>
								<div class="form-group col-lg-6">
									<label for="accList">取引先</label> 
									<select id="accList" name="accList"class="form-control validate">
								...
								<div class="form-group col-lg-6">
									...
									<input id="rComment" name="rComment" type="text" class="form-control validate" />
								</div>
