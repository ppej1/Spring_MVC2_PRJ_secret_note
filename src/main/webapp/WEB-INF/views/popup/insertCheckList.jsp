				...
				<div class="">
					<div class="tm-bg-primary-dark tm-block tm-block-settings">
						<form id="checklistform" action="insertCheckList" method="post">
							...
							<div class="tm-signup-form row">
								...
								<div class="form-group col-lg-6">
									<label for="importance">会社名</label> <select id="importance"
										name="importance" class="form-control validate">
										<option value="3">상</option>
										<option value="2">중</option>
										<option value="1">하</option>
									</select> <span id=""></span> <input type="hidden" name="completes"
										id="completes">
								</div>
								<div class="form-group col-lg-6">
									<label for="ckTitle">会社のホームページ</label> <input id="ckTitle"
										name="ckTitle" type="text" class="form-control validate" />
								</div>
							</div>
						</form>
						<div class="col-12 button_popup">
							...
							<button type="button"
								class="btn btn-primary btn-block text-uppercase" id="createBtn">登録</button>
						</div>
						<div class="col-12">
							<label class="tm-hide-sm">&nbsp;</label>
							<button type="button"
								class="btn btn-primary btn-block text-uppercase" id="cancelBtn">キャンセル</button>
						</div>
					</div>
				</div>
			</div>
