						...
						<div class="tm-bg-primary-dark tm-block tm-block-settings">
							...
							<div class="tm-signup-form row">
								<div class="form-group col-lg-6">
									<label for="mcserialNumber">大分類</label> <select
										id="mcserialNumber" size="1" name="mcserialNumber"
										class="form-control validate select_mcserialNumber">

									</select> <span id="mcserialNumber"></span>
								</div>
								<div class="form-group col-lg-6">
									<label for="foodCode">FOOD CODE</label> <input id="foodCode"
										name="foodCode" type="text" class="form-control validate" />
									<span id="foodCode"></span>
								</div>
								<div class="form-group col-lg-6">
									<label for="sName">材料名</label> <input id="sName" name="sName"
										type="text" class="form-control validate" /> <span id="sName"></span>
								</div>
								<div class="form-group col-lg-6">
									<label for="unit">単位</label> <select id="unit" name="unit"
										class="form-control validate">
										<option value="">a</option>
										<option value="">a</option>
										<option value="">a</option>
										<option value="">a</option>
									</select> <span id="unit"></span>
								</div>
								<div class="form-group col-lg-6">
									<label for="price">価格</label> <input id="price" name="price"
										type="number" class="form-control validate" />
								</div>
								<div class="form-group col-lg-6">
									<label for="location">貯蔵位置</label> <select id="location"
										name="mcserialNumber" class="form-control validate">
										<option value="1">冷凍</option>
										<option value="2">冷蔵</option>
										<option value="3">常温</option>
									</select> <span id="location"></span>
								</div>
								<div class="form-group col-lg-6">
									<label for="eDate">賞味期限</label> <input id="eDate" name="eDate"
										type="number" class="form-control validate" />
								</div>
							</div>
							<div class="col-12 button_popup">
								...
								<button type="button"
									...
									onclick="regdata();">登録</button>
							</div>
							<div class="col-12">
								<label class="tm-hide-sm">&nbsp;</label>
								<button type="button"
									class="btn btn-primary btn-block text-uppercase" id="btnExit">キャンセル</button>
							</div>
						</div>
					</div>
				</div>
	...
	<script>
		...
		function outputMainClass(data) {
			...
			$.each(data, function(index, item) {
				tag += '<option value="'+ item.mcSerialNumber +'">'
						+ item.mclass + '</option>';
			});
